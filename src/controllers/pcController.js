...
const getAllPCs = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const [rows] = yield database_1.db.query('SELECT * FROM PC');
    res.json(rows);
});
exports.getAllPCs = getAllPCs;
const addPC = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { name, owner } = req.body;
    const [result] = yield database_1.db.query('INSERT INTO PC (name, owner) VALUES (?, ?)', [name, owner]);
    res.json({ id: result.insertId, name, owner });
});
exports.addPC = addPC;
const updatePC = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const { name, owner } = req.body;
    yield database_1.db.query('UPDATE PC SET name = ?, owner = ? WHERE id = ?', [name, owner, id]);
    res.sendStatus(200);
});
exports.updatePC = updatePC;
const deletePC = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    yield database_1.db.query('DELETE FROM PC WHERE id = ?', [id]);
    res.sendStatus(200);
});
